  ...
  return (
    <div className=" bg-white shadow-clay-card rounded-lg py-6 flex flex-col items-center w-full max-w-sm">
      <div className="photo-wrapper mb-4">
        <img className="w-24 h-24 rounded-full mx-auto" src={developer.image} alt={`${developer.githubUsername}'s avatar`} />
      </div>
      <div className="text-center">
        <h3 className="text-xl text-gray-900 font-medium leading-8">{developer.githubUsername}</h3>
        ...
        <table className="text-xs my-3 w-full">
          <tbody>
            <tr>
              <td className="px-2 py-2 text-gray-500 font-semibold">Contributions</td>
              <td className="px-2 py-2">{developer.contributions}</td>
            </tr>
            <tr>
